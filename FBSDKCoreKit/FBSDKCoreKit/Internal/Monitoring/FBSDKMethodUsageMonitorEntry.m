...
- (instancetype)initWithCoder:(NSCoder *)decoder
{
  if (self = [super initWithCoder:decoder]) {
    NSString *methodName = [decoder decodeObjectForKey:FBSDKMethodUsageNameKey];
    self.method = NSSelectorFromString(methodName);
    self.parameters = [decoder decodeObjectForKey:FBSDKMethodUsageParametersKey];
  }
